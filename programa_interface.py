...
boton_mult = Button(ventana, text = "X", width= 5, height= 2,command = lambda: click_button("*"))
boton_sum = Button(ventana, text = "+", width= 5, height= 2,command = lambda: click_button("+"))
boton_rest = Button(ventana, text = "-", width= 5, height= 2,command = lambda: click_button("-"))
